...
__attribute__((section("__versions"))) = {
	...
	{ 0x9e4a19b0, "simple_attr_release" },
	{ 0xdd680dbc, "simple_attr_write" },
	{ 0x1370aa6c, "simple_attr_read" },
	{ 0x7aaf6733, "generic_file_llseek" },
	...
	{ 0x854efc84, "simple_attr_open" },
	{ 0xbd1e3af4, "debugfs_remove" },
